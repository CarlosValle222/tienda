...
<div class="container">
	...
	<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Historial de Compra</h1>
        </div>
    </div>
                <!-- /.row -->
				<div class="row">
								...
								while($hrow=mysqli_fetch_array($h)){
									?>
										<tr>
											...
											<td>
												<a href="#detail<?php echo $hrow['salesid']; ?>" data-toggle="modal" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-fullscreen"></span> vista de producto</a>
